...
* This project is deployed online with IP: _**18.221.3.181**_ using Termius along with the help AWS-EC2 using various Linux commands so that the mysql database and commands works on it
